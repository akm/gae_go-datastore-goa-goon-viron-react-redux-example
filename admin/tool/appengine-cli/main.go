...
import (
	"fmt"
	"github.com/akm/gae_go-datastore-goa-goon-viron-react-redux-example/admin/client"
	"github.com/akm/gae_go-datastore-goa-goon-viron-react-redux-example/admin/tool/cli"
...
func main() {
	...
	app := &cobra.Command{
		Use:   "appengine-cli",
		Short: `CLI client for the appengine service`,
	}
